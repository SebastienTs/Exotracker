...
load_images_tiff.proteins.native.setStyleSheet("color: blue;")
...
graph_tracks.plot_intensity_profiles.native.setStyleSheet("color: blue;")
graph_tracks.intnorm.native.setStyleSheet("padding-left: 40px;")
graph_tracks.plot_average_intensity_profile.native.setStyleSheet("color: blue;")
graph_tracks.native.setStyleSheet("background-color: #202020")
graph_tracks.export_trinity.native.setStyleSheet("color: blue;")
